...
from utils.util import fetch_json, check_include, normalize
...
class MusicAnalyzer:
    ...
    def analyze(self):
        ...
        if status != 'SUCCEEDED':
            ...
            self.root_key = results['Root key']
